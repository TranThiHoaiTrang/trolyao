...
<section class="content">
	<form class="validation-form" novalidate method="post" action="<?= $linkSave ?>" enctype="multipart/form-data">
			...
			<div class="card-body">
				...
				<div class="row">
					...
					<?php if (isset($config['setting']['dienthoai_nv']) && $config['setting']['dienthoai_nv'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="dienthoai_nv">Điện thoại nhân viên trực:</label>
							<input type="text" class="form-control" name="data[options][dienthoai_nv]" id="dienthoai_nv" placeholder="Điện thoại nhân viên trực" value="<?= $options['dienthoai_nv'] ?>">
						</div>
					<?php } ?>
					...
					<?php } ?>
					<?php if (isset($config['setting']['excel']) && $config['setting']['excel'] == true) { ?>
						<div class="form-group col-md-12 col-sm-12">
							<label for="excel">Link excel:</label>
							<textarea type="text" class="form-control" name="data[options][excel]" id="excel" placeholder="File excel"><?= htmlspecialchars_decode($options['excel']) ?></textarea>
						</div>
					<?php } ?>
					<?php if (isset($config['setting']['file_excel']) && $config['setting']['file_excel'] == true) { ?>
						<div class="form-group col-md-12 col-sm-12">
							<label for="file_excel">File excel iframe:</label>
							<textarea type="text" class="form-control" name="data[options][file_excel]" id="file_excel" placeholder="File excel"><?= htmlspecialchars_decode($options['file_excel']) ?></textarea>
						</div>
					<?php } ?>
					<?php if (isset($config['setting']['tg_hoatdong']) && $config['setting']['tg_hoatdong'] == true) { ?>
						<div class="form-group col-md-12 col-sm-12">
							<label for="tg_hoatdong">Thời gian hoạt động:</label>
							<input type="text" class="form-control" name="data[options][tg_hoatdong]" rows="5" id="tg_hoatdong" placeholder="Thời gian hoạt động" value="<?= $options['tg_hoatdong'] ?>">
						</div>
					<?php } ?>
				</div>
		...
		<div class="card card-primary card-outline text-sm">
			...
			<div class="card-body">
				<?php
				$seoDB = $seo->getSeoDB($id, $com, 'capnhat', $type);
