            ...
            <ul data-accordion="true" class="nav nav-pills nav-sidebar flex-column nav-child-indent text-sm" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <?php if(isset($v['danhmuc']) && $v['danhmuc'] == true) {
                                    ...
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_danhmuc&type=<?=$k?>" title="Danh mục"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Bộ luật</p></a></li>
                                <?php } ?> 
                                <?php if(isset($v['danhmuc_cap']) && $v['danhmuc_cap'] == true) {
                                    ...
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_danhmuc_cap&type=<?=$k?>" title="Danh mục cấp"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Chương</p></a></li>
                                <?php } ?> 
                                <?php
                                    $none = "";
                                    $active = "";
                                ...
                                <?php if(isset($v['loaivai']) && $v['loaivai'] == true) {
                                    ...
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_loaivai&type=<?=$k?>" title="Danh mục Loại vải"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Loại vải</p></a></li>
                                <?php } ?>
                                ...
                                <?php if(isset($v['muavu']) && $v['muavu'] == true) {
                                    ...
                                    <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_muavu&type=<?=$k?>" title="Danh mục Mùa vụ"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Mùa vụ</p></a></li>
                                <?php } ?>
                                <?php if(isset($v['import']) && $v['import'] == true) {
                                    $none = "";
                                    $active = "";
                ...
                <!-- </?php if(isset($config['redirect'])) { ?> -->
                    <!-- </?php
                        ...
                        $active = "";
                        $menuopen = "";
                        if(isset($kiemtra) && $kiemtra == true) if($func->check_access('redirect', 'man', '', $config['redirect'], 'phrase-2')) $none = "d-none";
                        if($com=='redirect' && !isset($disabled['redirect'][$_GET['type']]))
                        {
                            $active = 'active';
                            $menuopen = 'menu-open';
                        }
                    ...
                    <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            ?>
                            <li class="nav-item <?=$none?>">
                                <a class="nav-link <?=$active?>" href="index.php?com=redirect&act=man&type=redirect" title="redirect"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Redirect</p></a>
                            </li>
                        </ul>
                    </li> -->
                <!-- </?php } ?> -->
                ...
                <!-- </?php
                    ...
                    $active = "";
                    $menuopen = "";
                    if(isset($kiemtra) && $kiemtra == true) if($func->check_access('contact', 'man', '', $config['redirect'], 'phrase-2')) $none = "d-none";
                    if($com=='contact' && !isset($disabled['contact'][$_GET['type']]))
                    {
                        $active = 'active';
                        $menuopen = 'menu-open';
                    }
                ...
                <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                    ...
                    <ul class="nav nav-treeview">
                            ...
                            $none = "";
                            $active = "";
                            if(isset($kiemtra) && $kiemtra == true) if($func->check_access('contact', 'man', $k, null, 'phrase-1')) $none = "d-none";
                            if($com=='contact' && 'contact'==$_GET['type']) $active = "active";
                        ?>
                        <li class="nav-item <?=$none?>">
                            <a class="nav-link <?=$active?>" href="index.php?com=contact&act=man&type=contact" title="Liên hệ"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Liên hệ</p></a>
                        </li>
                    </ul>
                </li> -->
                    ...
                    <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                        ...
                        <ul class="nav nav-treeview">
                            <?php if(isset($config['permission']) && $config['permission'] == true) {
                                ...
                                <li class="nav-item"><a class="nav-link <?=$active?> <?=$none?>" href="index.php?com=user&act=permission_group" title="Nhóm quyền"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Nhóm quyền</p></a></li>
                            <?php } ?>
                            <?php
                                $active = "";$none = '';
                                ...
                                if(isset($kiemtra) && $kiemtra == true) if($func->check_access('user', 'capnhat', '', null, 'phrase-1')) $none = "d-none";
                            ?>
                            <li class="nav-item"><a class="nav-link <?=$active?> <?=$none?>" href="index.php?com=user&act=admin_edit" title="Thông tin admin"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Thông tin admin</p></a></li>
                            <?php if(isset($config['user']['admin']) && $config['user']['admin'] == true) {
                                $active = "";$none = '';
                                if(isset($kiemtra) && $kiemtra == true) if($func->check_access('user', 'capnhat', '', null, 'phrase-1')) $none = "d-none";
                                if($act=='man_admin' || $act=='add_admin' || $act=='edit_admin') $active = "active"; ?>
                                <li class="nav-item"><a class="nav-link <?=$active?> <?=$none?>" href="index.php?com=user&act=man_admin" title="Tài khoản admin"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Tài khoản admin</p></a></li>
                            <?php } ?>
                            <?php if(isset($config['user']['admin']) && $config['user']['admin'] == true) {
                                $none = '';
                                if(isset($kiemtra) && $kiemtra == true) if($func->check_access('user', 'capnhat', '', null, 'phrase-1')) $none = "d-none";
                                $active = "";
                                if($act=='man_admin_cap' || $act=='add_admin_cap' || $act=='edit_admin_cap') $active = "active"; ?>
                                <li class="nav-item"><a class="nav-link <?=$active?> <?=$none?>" href="index.php?com=user&act=man_admin_cap" title="Tài khoản cấp tỉnh"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Tài khoản cấp tỉnh</p></a></li>
                            <?php } ?>
                            <?php if(isset($config['user']['visitor']) && $config['user']['visitor'] == true) {
                                $none = '';
                                if(isset($kiemtra) && $kiemtra == true) if($func->check_access('user', 'visitor' , '', null, 'phrase-1')) $none = "d-none";
                                $active = "";
                                if($com=='user' && ($act=='man' || $act=='add' || $act=='edit')) $active = "active"; ?>
                                <li class="nav-item"><a class="nav-link <?=$active?> <?=$none?>" href="index.php?com=user&act=man" title="Tài khoản khách"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Tài khoản khách</p></a></li>
                            <?php } ?>
                        </ul>
                    </li>
                <?php } ?>
                ...
                ?>
                <li class="nav-item <?=$active?> <?=$none?>">
                    <a class="nav-link <?=$active?>" href="index.php?com=setting&act=capnhat&type=setting" title="Thiết lập thông tin">
