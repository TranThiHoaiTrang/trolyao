	...
	<form class="validation-form" novalidate method="post" action="<?= $linkSave ?>" enctype="multipart/form-data">
		...
		<div class="card card-permission card-primary card-outline text-sm">
			...
			<div class="card-body">
				<div class="form-group">
					<div class="custom-control custom-checkbox text-md">
						<input type="checkbox" class="custom-control-input" name="dataQuyen[]" id="quyen-visitor" value="user_visitor" <?= (isset($ds_quyen) && in_array('user_visitor', $ds_quyen)) ? 'checked' : ''; ?>>
						<label for="quyen-visitor" class="custom-control-label font-weight-normal">Quyền thêm thành viên</label>
					</div>
				</div>
			</div>
		</div>
