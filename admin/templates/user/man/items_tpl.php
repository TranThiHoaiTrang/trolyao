...
<section class="content">
    ...
    <div class="card card-primary card-outline text-sm mb-0">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a class="btn btn-sm bg-gradient-success btn-export-excel btn-sm d-inline-block align-middle ml-2 text-white" onclick="actionOrder('index.php?com=excelAll_user')" title="Xuất file Excel"><i class="far fa-file-excel mr-1"></i>Xuất file Excel</a>
        </div>
                    ...
                    <tbody>
                        <?php for ($i = 0; $i < count($items); $i++) { ?>
                            <tr>
                                ...
                                <td class="align-middle">
                                    <?php
                                    $temps = $d->rawQueryOne("select id_donvi from #_member where id = ? limit 0,1", array($items[$i]['id']));
                                ...
                                <!-- <td class="align-middle">
                                    <a class="text-dark" href="<?= $linkEdit ?>&id=<?= $items[$i]['id'] ?>" title="<?= $items[$i]['nguoitao'] ?>"><?= $items[$i]['nguoitao'] ?></a>
                                </td> -->
