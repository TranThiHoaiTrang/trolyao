	            ...
	            <table class="table table-hover">
	                <thead>
	                    <tr>
							...
							<th class="align-middle text-center">Chiết khấu</th>
	                ...
	                <?php } else { ?>
	                    <tbody>
	                        <?php foreach($chitietdonhang as $k => $v) { ?>
	                            <tr>
	                                ...
	                                <td class="align-middle text-right">
	                                	<div class="price-cart-detail">
											<?php if($v['giasale']) { ?>
												<span class="price-new-cart-detail"><?=$func->format_money($v['giasale']*$v['soluong'])?></span>
	                        ...
	                        <?php if(
		                        ...
		                        <tr>
									<td colspan="6" class="title-money-cart-detail">Tạm tính:</td>
									<td colspan="1" class="cast-money-cart-detail"><?=$func->format_money($item['tamtinh'])?></td>
								</tr>
							<?php } ?>
							<?php if(isset($config['order']['ship']) && $config['order']['ship'] == true) { ?>
								<tr>
									<td colspan="6" class="title-money-cart-detail">Phí vận chuyển:</td>
							...
							<?php } ?>
							<tr>
								<td colspan="6" class="title-money-cart-detail">Tổng giá trị đơn hàng:</td>
