<?php
	...
	function save_seopage()
	{
		...
		if (isset($_POST['canonicalvi'])) $dataSeo['canonicalvi'] = $func->changeTitle(htmlspecialchars($_POST['canonicalvi']));
		if (isset($_POST['canonicalen'])) $dataSeo['canonicalen'] = $func->changeTitle(htmlspecialchars($_POST['canonicalen']));
		// var_dump($data);die();
