<?php
$list_vb_ks = $d->rawQuery("select * FROM table_product_list WHERE type = 'he-thong-bieu-mau' and hienthi > 0 order by stt,id desc");
?>
<div class="fixwidth">
                    ...
                    <div class="trolyao_layout_center_boloc">
                        <div class="all_frm_timkiem">
                            <div class="frm_timkiem">
                                ...
                                <input type="text" class="input" id="keyword_hethongbieumau" placeholder="Nhập từ khóa ..." onkeypress="doEnter_hethongbieumau(event,'keyword_hethongbieumau');" value="<?= $tukhoa2 ?>">
                            ...
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    foreach ($list_vb_ks as $spc) {
                                        $count_sanpham = $d->rawQueryOne("select count(id) as numb from #_product where id_list = '" . $spc['id'] . "' $where and hienthi>0 and type='he-thong-bieu-mau' order by stt,id desc");
                                ...
                                <div class="tab-content" style="padding-top: 10px;">
                                    <div class="tab-pane active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        <div class="all_vanban_kiemsoat">
                                            ...
                                            $loaivanban = $d->rawQuery("select * from #_product where type='he-thong-bieu-mau' $where and hienthi>0 order by stt,id asc $limit");

                                            $sqlNum = "select count(*) as 'num' from #_product where type='he-thong-bieu-mau' $where and hienthi>0 order by stt,id asc";
                                            ...
                                            foreach ($loaivanban as $v) {
                                                $loaivanban_list = $d->rawQueryOne("select * from #_product_list where id = '" . $v['id_list'] . "' and hienthi>0 and type='he-thong-bieu-mau' order by stt,id asc");
                                                $i++;
                                            ?>
                                    ...
                                    <?php foreach ($list_vb_ks as $spc) { ?>
                                        <div class="tab-pane" id="<?= $spc['id'] ?>" role="tabpanel" aria-labelledby="<?= $spc['id'] ?>-tab">
                                            <div class="all_vanban_kiemsoat">
                                                ...
                                                $loaivanban = $d->rawQuery("select * from #_product where type='he-thong-bieu-mau' and id_list = '" . $spc['id'] . "' $where and hienthi>0 order by stt,id asc $limit");

                                                $sqlNum = "select count(*) as 'num' from #_product where type='he-thong-bieu-mau' and id_list = '" . $spc['id'] . "' $where and hienthi>0 order by stt,id asc";
                                                $count = $d->rawQueryOne($sqlNum, $params);
                                                $total = $count['num'];
                                                $url = $func->getCurrentPageURL();
                                                $paging = $func->pagination($total, $per_page, $curPage, $url);
