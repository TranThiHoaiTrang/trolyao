                            ...
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    foreach ($list_vb_ks as $spc) {
                                        $count_sanpham = $d->rawQueryOne("select count(id) as numb from #_product where id_list = '" . $spc['id'] . "' $where and hienthi>0 and type='phonghop-khonggiay' order by stt,id desc");
                                ...
                                <div class="tab-content" style="padding-top: 10px;">
                                    <div class="tab-pane active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        <div class="all_vanban_kiemsoat">
                                            ...
                                            <?php
                                            $loaivanban = $d->rawQuery("select * from #_product where type='phonghop-khonggiay' $where and hienthi>0 order by stt,id asc");
                                            $i = 0;
                                    ...
                                    <?php foreach ($list_vb_ks as $spc) { ?>
                                        <div class="tab-pane" id="<?= $spc['id'] ?>" role="tabpanel" aria-labelledby="<?= $spc['id'] ?>-tab">
                                            <div class="all_vanban_kiemsoat">
                                                ...
                                                <?php
                                                $loaivanban = $d->rawQuery("select * from #_product where type='phonghop-khonggiay' and id_list = '" . $spc['id'] . "' $where and hienthi>0 order by stt,id asc");
                                                $i = 0;
                                                foreach ($loaivanban as $v) {
                                                    $i++;
                                                ?>
