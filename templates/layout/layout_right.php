<button type="button" class="btn btn_share btn-chiasetructuyen" data-toggle="modal" data-target="#popup_chiasetructuyen">
    <div style="position: relative;">
        <div class="animated infinite zoomIn kenit-alo-circle"></div>
        <div class="animated infinite pulse kenit-alo-circle-fill"></div>
        <span>Chia sẻ trực tuyến</span>
    </div>
    <img src="./assets/images/chiase3.jpg" alt="" style="border-radius: 50%;position: relative;background: #fff;" width="50" height="50">
</button>
<button type="button" class="btn btn_share btn-trolyao" data-toggle="modal" data-target="#popup_trolyao">
    <div style="position: relative;">
        <div class="animated infinite zoomIn kenit-alo-circle"></div>
        <div class="animated infinite pulse kenit-alo-circle-fill"></div>
        <span>Kiểm sát viên AI</span>
    </div>
    <img src="./assets/images/ic-bot.png" alt="" style="border-radius: 50%;position: relative;background: #fff;" width="50" height="50">
</button>
                                ...
                                <div class="all_tinnhan_gpt">
                                    <div class="all_tinnhan_gpt_data">
                                        ...
                                        ?>
                                            ...
                                            <?php
                                            $messages_all = $d->rawQuery("select * from #_messages_gpt where cookie_user = '".$_COOKIE['login_session']."' order by id asc");
                                            foreach ($messages_all as $v) {
                                                if ($v['name_user'] != 'ai') {
                                            ?>
                                                    <div class="all_box_trolyao_text_user">
                                                        <span><?= $v['noidung'] ?></span>
