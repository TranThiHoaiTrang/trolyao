...
if (!empty($_POST["keyword"])) {
    ...
    // var_dump($where);
    $data = $d->rawQuery("select * from #_product where type = 'tinh-huong-phap-ly' $where ");
    $data_dm = $d->rawQuery("select * from #_product_danhmuc where type = 'tinh-huong-phap-ly' $where ");
